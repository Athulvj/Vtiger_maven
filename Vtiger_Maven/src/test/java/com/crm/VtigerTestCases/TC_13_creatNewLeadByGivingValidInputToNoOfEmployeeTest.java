...
public class TC_13_creatNewLeadByGivingValidInputToNoOfEmployeeTest extends BaseClass {
	@Test(groups="smoke",retryAnalyzer=com.crm.Vtiger.GenericUtilities.RetryAnalyzer.class)
	public void creatNewLeadByGivingValidInputToNoOfEmployeeTest() throws Throwable {
		...
		String NoofEmployess = elib.getDataFromExcel("LeadData", 4, 1);
		...
		clp.enterNoOfEmplyess(NoofEmployess);
		clp.clickOnSaveBtn();
